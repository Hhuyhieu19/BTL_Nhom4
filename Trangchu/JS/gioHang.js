...
var cartProductImage = document.querySelector('.img_product');
cartProductImage.innerHTML = '<img src="../../Phanmem/IMG/sp1/a1.jpg' + localStorage.getItem('productImage') + '">';

var cartProductName = document.querySelector('.product_name');
cartProductName.innerHTML = localStorage.getItem('productName');

var cartProductPrice = document.querySelector('.price');
cartProductPrice.innerHTML = localStorage.getItem('productPrice');
